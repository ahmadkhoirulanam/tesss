...
<main id="js-page-content" role="main" class="page-content">
     <div class="row">
		 ...
		 <div id="panel-1" class="panel">
			<div class="panel-hdr">
				<h2>Instrumen Respon Dosen Terhadap Tata Pamong Dan Tata Kelola Lembaga Universitas Pgri Semarang</h2>
			...
			<div class="panel-container show">
				...
				<form method="post" action="<?php echo baseurl("angket-action");?>">
					...
					<div class="row">
						...
						<p>Kuisioner ini bertujuan untuk mengukur Respon Dosen Terhadap Tata Pamong Dan Tata Kelola Lembaga Universitas Pgri Semarang</p>
						...
						<?php
							$query = $db->prepare("SELECT * FROM angket_d003 WHERE sha1(id) = ?");
							$query->execute([$prm]);
						...
						<div class="col-md-12 pt-2 pb-2 bg-primary-800 text-white">
							 <strong><em>Respon Dosen Terhadap Tata Pamong Dan Tata Kelola Lembaga</em></strong>
						</div>
						<div class="col-md-12 p-2">
						...
						<div class="col-md-12 pt-2 pb-2 pl-1 pr-1 text-center">
							<button type="submit" class="btn btn-primary" name="<?php echo $button;?>-d003">Simpan</button>	
						</div>
