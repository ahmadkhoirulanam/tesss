...
<main id="js-page-content" role="main" class="page-content">
     ...
     <div class="col-md-12">
        ...
        <div class="form-group row mb-3">
            <div class="col-md-9 ">
                <h1 class="subheader-title"><i class="subheader-icon fal fa-tachometer-alt"></i> Angket Master <small></small></h1>
            </div>
        </div>
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                            ...
                            <tbody>
                            <?php
							$qa=$db->prepare("SELECT * FROM angket_master");
							$qa->execute();
							if($qa->rowCount()==0){
							...
							?>  								
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $r->nmangket; ?></td>
                                    
                                    <td align="center">
                                        <button type="button" class="btn btn-sm btn-primary"><span class="fal fa-pencil mr-1"></span>Edit</button>
                                        <button type="button" class="btn btn-sm btn-danger"><span class="fal fa-trash mr-1"></span>Hapus</button>
