...
<main id="js-page-content" role="main" class="page-content">
     <div class="row">
		 ...
		 <div id="panel-1" class="panel">
			<div class="panel-hdr">
				<h2>Angket Kepuasan Dosen Terhadap Sarana Dan Prasarana</h2>
				
			</div>
			<div class="panel-container show">
				<div class="panel-content">
					<!-- <form method="post" action="<?php echo baseurl("iss/angket-action");?>">
						<input type="hidden" name="kdangket" value="1">
						<input type="hidden" name="kduser" value="<?php //echo $_SESSION["kduser"];?>">
						<input type="hidden" name="kdprodi" value="<?php //echo $ruser->kdprodi;?>"> -->
					...
					<div class="row">
						...
						<p>Kuisioner ini bertujuan untuk mengukur tingkat Kepuasan Dosen Terhadap Sarana Dan Prasarana</p>
						...
						<?php
							$query = $db->prepare("SELECT * FROM angket_d002 WHERE sha1(id) = ?");
							$query->execute([$prm]);
						...
						<div class="col-md-12 pt-2 pb-2 pl-1 pr-1 text-center">
							<button type="submit" class="btn btn-primary" name="<?php echo $button;?>-d002">Simpan</button>
						</div>
