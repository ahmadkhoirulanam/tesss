			...
			<div class="panel-container show">
				<div class="panel-content">
					...
					<div class="row">
						...
						<p>Kuisioner ini bertujuan untuk mengukur tingkat kepuasan mahasiswa terhadap layanan administrasi akademik Universitas PGRI Semarang dalam pelayanan pembelajaran pada mata kuliah</p>
						...
						<?php
							$query = $db->prepare("SELECT * FROM angket_m002 WHERE sha1(id) = ?");
							$query->execute([$prm]);
						...
						<div class="col-md-12 p-2">
							2.	Prosedur pelayanan jelas dan mudah dipahami
						</div>
						<div class="col-md-12 p-2">
							<div class="frame-wrap">
						...
						<div class="col-md-12 p-2">
							1.	Kemampuan fakultas dan prodi dalam melayani kebutuhan mahasiswa secara offline dan online (bimbingan, surat rekomendasi)
						</div>
						<div class="col-md-12 p-2">
							<div class="frame-wrap">
						...
						<div class="col-md-12 p-2">
							2.	Kemampuan staf administrasi dalam melayani kebutuhan mahasiswa secara offline dan online
						</div>
						<div class="col-md-12 p-2">
							<div class="frame-wrap">
						...
						<div class="col-md-12 p-2">
							<div class="frame-wrap">
								...
								<div class="custom-control custom-radio ">
									<input type="radio" required <?php if(isset($data['p7a'])=="1" ? $data['p7a']=="1" : ''){ echo "checked=checked";}  ?> value="1" class="custom-control-input" id="p71a" name="p7a">
									<label class="custom-control-label" for="p71a">Sangat kurang</label>
								</div>
								<div class="custom-control custom-radio ">
									<input type="radio" required <?php if(isset($data['p7a'])=="2" ? $data['p7a']=="2" : ''){ echo "checked=checked";}  ?> value="2" class="custom-control-input" id="p72a" name="p7a">
									<label class="custom-control-label" for="p72a">Kurang</label>
								</div>
								<div class="custom-control custom-radio ">
									<input type="radio" required <?php if(isset($data['p7a'])=="3" ? $data['p7a']=="3" : ''){ echo "checked=checked";}  ?> value="3" class="custom-control-input" id="p73a" name="p7a">
									<label class="custom-control-label" for="p73a">Baik</label>
								</div>
								<div class="custom-control custom-radio e">
									<input type="radio" required <?php if(isset($data['p7a'])=="4" ? $data['p7a']=="4" : ''){ echo "checked=checked";}  ?> value="4" class="custom-control-input" id="p74a" name="p7a">
									<label class="custom-control-label" for="p74a">Sangat Baik</label>
								</div>
						...
						<div class="col-md-12 p-2">
							1.	Komunikasi staf administrasi terhadap mahasiswa
						</div>
						<div class="col-md-12 p-2">
							<div class="frame-wrap">
						...
						<div class="col-md-12 p-2">
							2.	Kemudahan dalam proses pembayaran biaya kuliah
						</div>
						<div class="col-md-12 p-2">
							<div class="frame-wrap">
						...
						<div class="col-md-12 p-2">
							3.	Kemudahan dalam proses mengurus perizinan akademik
						</div>
						<div class="col-md-12 p-2">
							<div class="frame-wrap">
						...
						<div class="col-md-12 p-2">
							1.	Dosen wali, prodi, fakultas memberikan bantuan jika mahasiswa mengalami permasalahan akademik
						</div>
						<div class="col-md-12 p-2">
							<div class="frame-wrap">
						...
						<div class="col-md-12 p-2">
							2.	Dosen wali, prodi, fakultas memberikan waktu pada orangtua/ wali mahasiswa untuk berkonsultasi
						</div>
						<div class="col-md-12 p-2">
							<div class="frame-wrap">
						...
						<div class="col-md-12 p-2">
							3.	Prodi memberikan bantuan kepada mahasiswa yang mengalami musibah
						</div>
						<div class="col-md-12 p-2">
							<div class="frame-wrap">
						...
						<div class="col-md-12 p-2">
							1.	Prodi dan fakultas memonitor perkembangan akademik mahasiswa melalui dosen wali
						</div>
						<div class="col-md-12 p-2">
							<div class="frame-wrap">
						...
						<div class="col-md-12 p-2">
							2.	Dosen bersikap kooperatif terhadap mahasiswa
						</div>
						<div class="col-md-12 p-2">
							<div class="frame-wrap">
						...
						<div class="col-md-12 pt-2 pb-2 pl-1 pr-1 text-center">
							<button type="submit" class="btn btn-primary" name="<?php echo $button;?>-m002">Simpan</button>	
					 	</div>
