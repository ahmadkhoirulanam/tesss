...
<main id="js-page-content" role="main" class="page-content">
     <div class="row">
		 ...
		 <div id="panel-1" class="panel">
			<div class="panel-hdr">
				<h2>Angket Kepuasan Tenaga Kependidikan Terhadap Layanan Administrasi Lembaga</h2>
			...
			<div class="panel-container show">
				<div class="panel-content">
					...
					<div class="row">
						...
						<p>Kuisioner ini bertujuan untuk mengukur tingkat kepuasan Tenaga Kependidikan terhadap Layanan Administrasi Lembaga</p>
						...
						<?php
							$query = $db->prepare("SELECT * FROM angket_t001 WHERE sha1(id) = ?");
							$query->execute([$prm]);
						...
						<div class="col-md-12 p-2">
							1.	Kemampuan lembaga dalam melayani kebutuhan tendik secara offline dan online 
						<div class="col-md-12 p-2">
							<div class="frame-wrap">
						...
						<div class="col-md-12 p-2">
							2.	Kemampuan staf administrasi Lembaga dalam melayani kebutuhan tendik secara offline dan online
						</div>
						<div class="col-md-12 p-2">
							<div class="frame-wrap">
						...
						<div class="col-md-12 p-2">
							1.	Kemampuan komunikasi staf administrasi Lembaga terhadap tendik
						</div>
						<div class="col-md-12 p-2">
							<div class="frame-wrap">
						...
						<div class="col-md-12 p-2">
							2.	Kemudahan dalam proses mengurus administrasi 
						</div>
						<div class="col-md-12 p-2">
							<div class="frame-wrap">
						...
						<div class="col-md-12 p-2">
							1.	Lembaga memberikan bantuan jika tendik mengalami permasalahan 
						</div>
						<div class="col-md-12 p-2">
							<div class="frame-wrap">
						...
						<div class="col-md-12 p-2">
							2.	lembaga memberikan waktu pada bagi tendik untuk berkonsultasi
						</div>
						<div class="col-md-12 p-2">
							<div class="frame-wrap">
						...
						<div class="col-md-12 p-2">
							3.	Lembaga memberikan bantuan kepada tendik yang mengalami musibah
						</div>
						<div class="col-md-12 p-2">
							<div class="frame-wrap">
						...
						<div class="col-md-12 p-2">
							1.	Lembaga memonitor perkembangan karir tendik
						</div>
						<div class="col-md-12 p-2">
							<div class="frame-wrap">
						...
						<div class="col-md-12 p-2">
							2.	Lembaga bersikap kooperatif terhadap tendik
						</div>
						<div class="col-md-12 p-2">
							<div class="frame-wrap">
						...
						<div class="col-md-12 pt-2 pb-2 mt-3 mb-2 bg-primary-800 text-white">
							 <strong>Berikan saran anda terkait layanan adminstrasi </strong>
						</div>
						...
						<div class="col-md-12 pt-2 pb-2 pl-1 pr-1 text-center">
							<button type="submit" class="btn btn-primary" name="<?php echo $button;?>-t001">Simpan</button>	
						</div>
