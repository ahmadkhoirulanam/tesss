                        ...
                        <div class="d-flex align-items-center container p-0">
                            <div class="page-logo width-mobile-auto m-0 align-items-center justify-content-center p-0 bg-transparent bg-img-none shadow-0 height-9">
                                <a href="javascript:void(0)" class="page-logo-link press-scale-down d-flex align-items-center">
                                    ...
                                    <span class="fs-xxl fw-500 text-white ml-3 mr-1">Form-Upgris</span>
                                </a>
                            </div>
                            ...
                            <div class="row">
                                <div class="col col-md-6 col-lg-7 hidden-sm-down">
                                    <h2 class="fs-xxl fw-500 mt-5 text-white">
                                        Management Form-Upgris
                                        <small class="h3 fw-300 mt-3 mb-5 text-white opacity-60">
                                        Selamat datang di halaman Sistem Management Form-Upgris. Silahkan masuk kedalam sistem melalui form login. Apabila anda bermasalah dengan akses sistem, silahkan hubungi Administrator Kepegawaian.
                                        </small>
                                    </h2>
                                    ...
                                    <div class="card p-4 rounded-plus bg-faded">
                                        ...
                                        if(isset($_POST['login'])) {
                                            ...
                                            if (mysqli_num_rows($sql_login) > 0) {
                                                ...
                                                echo "<script>window.location='".baseurl("admin")."';</script>";
